function [dataset, Y_train, Y_val, Y_test, label_train, label_val, label_test] = train_test_split(...
    dataset, N_train, N_val, N_test, seed)
%myrng();
...
switch dataset
        ...
        case 'myFlower'
            ...
            Y_test = normc(double(Y_test));
        otherwise
            [Y_train, label_train, Y_val, label_val] = ...
                pickTrainTest_2(dataset, N_train, N_val, N_test, seed);
    end
    fprintf('DONE\n');
end 
