...
% $Id: pm_defaults_Trio_al_64.m 7211 2017-11-13 10:38:15Z guillaume $
...
pm_def.TOTAL_EPI_READOUT_TIME = 18;   % Trio al_mepi_3d 3mm-res EPI: (1+0.125)*64/2*0.5 (Acceleration factor 2 along phase direction)
