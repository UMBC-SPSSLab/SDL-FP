...
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.name = 'Gunzip Files';
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.tag = 'cfg_gunzip_files';
...
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.prog = @cfg_run_gunzip_files;
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.vout = @cfg_vout_gunzip_files;
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.check = [];
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.rewrite_job = [];
matlabbatch{4}.menu_cfg.menu_struct.conf_exbranch.help = {'Gunzip each file in a set of files.'};
