...
% John Ashburner
% $Id: tbx_cfg_longitudinal.m 7563 2019-04-01 10:39:24Z guillaume $
...
write_div.labels  = {'Save', 'Dont save'};
...
write_jacd.labels = {'Save', 'Dont save'};
...
write_defs.labels = {'Save', 'Dont save'};
write_defs.values = { 1 0 };
write_defs.val    = {0};

%--------------------------------------------------------------------------
% long2 Pairwise Longitudinal Registration
%--------------------------------------------------------------------------
long2      = cfg_exbranch;
long2.tag  = 'pairwise';
...
%--------------------------------------------------------------------------
% long Serial Longitudinal Registration
%--------------------------------------------------------------------------
long       = cfg_exbranch;
long.tag   = 'series';
...
long.vout  = @vout_series;

%--------------------------------------------------------------------------
% longit Longitudinal Registration
%--------------------------------------------------------------------------
cfg        = cfg_choice;
cfg.tag    = 'longit';
