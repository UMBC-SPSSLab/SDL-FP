%-----------------------------------------------------------------------
% Job saved on 08-Feb-2017 12:34:54 by cfg_util (rev $Rev: 7703 $)
% spm SPM - SPM12 (12.3)
...
matlabbatch{3}.spm.tools.beamforming.sources.plugin.voi.vois{1}.voidef.label = '<UNDEFINED>';
matlabbatch{3}.spm.tools.beamforming.sources.plugin.voi.vois{1}.voidef.pos = '<UNDEFINED>';
